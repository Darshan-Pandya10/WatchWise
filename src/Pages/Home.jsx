...
const options = {
  ...
  headers: {
    ...
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhNGFjMTgwMjM2MTIxZTRhYmVjZDdiMzcyMWI0Njg0MSIsInN1YiI6IjY1OWQwOGU1Zjg1OTU4MDFhODExOTY0MyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.jl4vuS9kr0mczRAsBrD65L9yj0qZRMJ6OW_59d896zc",
  },
};
    ...
    <>
      <div className="intro relative pb-16 pt-20 md:pt-32 flex flex-col justify-around items-center md:flex-row md:justify-around md:item-center">
        <div className="p-8">
          ...
          <p className="tracking-wider text-[1.05rem]">
            Introducing WatchWise, your ultimate destination for unraveling the
            enchanting world of cinema! Immerse yourself in a cinematic journey
            like never before with our comprehensive movie database site.
            WatchWise is designed to be your go-to hub for all things movies,
            offering an extensive collection of film details at your fingertips.{" "}
          </p>
        </div>
        <img
          src={HeroSvg}
